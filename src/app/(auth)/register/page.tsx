  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="text-center">
        <h1 className="font-headline-lg font-black text-ink">Join PennyComic</h1>
      ...
      <ComicCard>
        <form className="flex flex-col gap-4">
          <div>
            ...
            <input type="text" className="w-full bg-surface-container-low border-2 border-border-heavy rounded-lg p-3 font-body-md focus:outline-none focus:border-primary focus:shadow-[2px_2px_0px_0px_rgba(0,90,182,0.3)] transition-all" placeholder="Penny User" />
          </div>
          <div>
