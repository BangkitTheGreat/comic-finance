...
export function TransactionFormModal({ open, onClose, editing, accounts, categories, currency }: Props) {
  ...
  return (
    <ComicDialog open={open} onClose={onClose} title={isEdit ? "Edit transaction" : "Add transaction"}>
